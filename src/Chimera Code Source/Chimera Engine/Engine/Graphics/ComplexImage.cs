...
// Info:      Complex Image public class : Image + Farsser
//-----------------------------------------------------------------------------
#endregion
...
{
    /// <summary>
    /// This Class Allow You To Use The Image public class With More Physics Options
    /// </summary>
    public class ComplexImage : Image, Helpers.Interface.IDrawable, Helpers.Interface.IDrawables
    {
        #region Fields
        ...
        /// </summary>
        /// <param name="size">Image Size</param>
        /// <param name="mass">Image Mass</param>
        ...
        /// <summary>
        /// Draw The Image Without Stretch Mode
        /// </summary>
