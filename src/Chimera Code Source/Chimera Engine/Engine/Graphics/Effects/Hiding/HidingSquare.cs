...
{
    /// <summary>
    /// This Class Allow You Using Hiding Square Effect
    /// </summary>
    public class HidingSquare : Helpers.Interface.IDrawable, Helpers.Interface.IDrawables
    {
        ...
        public HidingSquare(GraphicsDeviceManager graphics)
        {
        ...
        public HidingSquare(GraphicsDeviceManager graphics, Graphics.Image Image)
        {
            this.graphics = graphics;
        ...
        public void Initialize(float Size, Enumeration.EDirection direction)
        {
            hiding.Initialize(new Vector2(Size,Size), direction);
        }
        /// <summary>
        /// Update The Effect
        /// </summary>
