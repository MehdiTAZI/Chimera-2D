...
namespace Chimera.Graphics.Effects.Breaking
{
    ...
    /// </summary>
    public class BreakingLine : Chimera.Helpers.Interface.IUpdateable, Helpers.Interface.IDrawable, Helpers.Interface.IDrawables
    {
        ...
        public BreakingLine(GraphicsDeviceManager graphics)
        {
        ...
        public BreakingLine(GraphicsDeviceManager graphics,Graphics.Image Image)
        {
            this.graphics = graphics;
        ...
        /// </summary>
        /// <param name="Type">Type Of Line</param>
        /// <param name="Size">Set Size Of Each Image In The Collection Effect</param>
        
        public void Initialize(Enumeration.ELine Type,float Size)
        {
            if ( Type== Chimera.Graphics.Enumeration.ELine.Horizontal ) 
            breaking.Initialize(new Vector2(graphics.GraphicsDevice.Viewport.Width,Size));
            else if (Type == Chimera.Graphics.Enumeration.ELine.Vertical)
            breaking.Initialize(new Vector2(Size, graphics.GraphicsDevice.Viewport.Height));
        }
        /// <summary>
        /// Initalize Randomize Rotation
        /// </summary>
