...
{ 
    /// <summary>
    /// This Class Allow You Using Partial Fading Line Effect
    /// </summary>
    public class PartialFadingLine : Chimera.Helpers.Interface.IUpdateable, Helpers.Interface.IDrawable, Helpers.Interface.IDrawables
    {
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        /// <param name="Size">Effect Size</param>
        public void Initialize(GraphicsDeviceManager graphics, Enumeration.ELine Type, float Size)
        {
            if (Type == Chimera.Graphics.Enumeration.ELine.Horizontal)
                partialfading.Initialize(new Vector2(graphics.GraphicsDevice.Viewport.Width, Size));
            else if (Type == Chimera.Graphics.Enumeration.ELine.Vertical)
                partialfading.Initialize(new Vector2(Size, graphics.GraphicsDevice.Viewport.Height));
        }
        /// <summary>
        /// Update The Effect
        /// </summary>
