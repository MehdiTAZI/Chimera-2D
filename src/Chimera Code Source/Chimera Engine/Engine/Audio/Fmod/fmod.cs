...
namespace Chimera.Audio.FMOD
{
    ...
    */
    ...
    {
        public const int    number = 0x00041004;
    ...
    */
    ...
    [
        ...
        have nothing to do with the FMOD public class "Channel".<br>
    ...
    */
    public enum MODE :uint
    {
        ...
        NONBLOCKING            = 0x00010000,  /* For opening sounds and getting streamed subsounds (seeking) asyncronously.  Use Sound::getOpenState to poll the state of the sound as it opens or retrieves the subsound in the image. */
